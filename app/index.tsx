        ...
        <View className="w-full flex items-center px-4">
          ...
          <View className="relative mt-[18vh]">
            <Text className="text-3xl text-black font-bold text-center">
              ...
              with{" "}
              <Text className="text-secondary-200">Sewa Ghar</Text>
            </Text>
          </View>

          <Text className="text-sm font-pregular text-black-100 mt-7 text-center">
            Welcome to your go-to hub for finding reliable professionals in your area! Whether you need home services, appliance and electronics repairs, beauty services, and more, we’ve got you covered. Discover trusted experts at your fingertips.
          </Text>
